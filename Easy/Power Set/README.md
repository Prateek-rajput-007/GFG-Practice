<h2><a href="https://practice.geeksforgeeks.org/problems/power-set4302/1?page=9&sprint=94ade6723438d94ecf0c00c3937dad55&sortBy=submissions">Power Set</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string S, Find&nbsp;all the possible subsequences&nbsp;of the String in lexicographically-sorted order.</span></p>
